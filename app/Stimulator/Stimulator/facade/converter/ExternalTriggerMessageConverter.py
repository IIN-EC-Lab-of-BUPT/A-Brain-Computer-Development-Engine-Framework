...
# from Stimulator.facade.protobuf.out.ExternalTriggerService_pb2 import (ExternalTriggerMessage as
#                                                                               ExternalTriggerMessage_pb2)
#
# from Stimulator.facade.protobuf.out import ExternalTriggerService_pb2
from Collector.api.protobuf.ExternalTriggerService_pb2 import (ExternalTriggerMessage as
                                                                              ExternalTriggerMessage_pb2)

from Collector.api.protobuf import ExternalTriggerService_pb2
...
class ExternalTriggerMessageConverter:
    ...
    def __external_trigger_model_to_message_pb(cls, external_trigger_model: ExternalTriggerModel) \
            -> ExternalTriggerMessage_pb2:
        return ExternalTriggerService_pb2.ExternalTriggerMessage(
