...
class NeuracleReceiverImplement(EEGReceiverInterface):
    ...
    def __preprocess_data(self, data_bytes: bytes) -> list[ReceiverTransferModel]:
        ...
        # self.__current_date_position = self.__current_date_position + data_array.shape[1]
        self.__current_date_position = self.__current_date_position + sample_number/self.__downsampling_factor
