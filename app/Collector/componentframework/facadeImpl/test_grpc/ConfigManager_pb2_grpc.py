...
import componentframework.facadeImpl.test_grpc.ConfigManager_pb2 as ConfigManager__pb2
...
class ConfigManagerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReadGlobalConfig = channel.unary_unary(
                '/com.coreplantform.daemonproceed.controller.grpc.ConfigManagerService/ReadGlobalConfig',
        ...
        self.RegisterGlobalConfigUpdateCallback = channel.unary_stream(
                '/com.coreplantform.daemonproceed.controller.grpc.ConfigManagerService/RegisterGlobalConfigUpdateCallback',
        ...
        self.UpdateGlobalConfig = channel.unary_unary(
                '/com.coreplantform.daemonproceed.controller.grpc.ConfigManagerService/UpdateGlobalConfig',
                ...
                _registered_method=True)
        self.CancelAddListenerOnGlobalConfig = channel.unary_unary(
                '/com.coreplantform.daemonproceed.controller.grpc.ConfigManagerService/CancelAddListenerOnGlobalConfig',
                request_serializer=ConfigManager__pb2.CancelAddListenerOnGlobalConfigRequest.SerializeToString,
                response_deserializer=ConfigManager__pb2.CancelAddListenerOnGlobalConfigResponse.FromString,
                _registered_method=True)
...
class ConfigManagerServiceServicer(object):
    ...
    def CancelAddListenerOnGlobalConfig(self, request, context):
...
def add_ConfigManagerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CancelAddListenerOnGlobalConfig': grpc.unary_unary_rpc_method_handler(
                    servicer.CancelAddListenerOnGlobalConfig,
                    request_deserializer=ConfigManager__pb2.CancelAddListenerOnGlobalConfigRequest.FromString,
                    response_serializer=ConfigManager__pb2.CancelAddListenerOnGlobalConfigResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'com.coreplantform.daemonproceed.controller.grpc.ConfigManagerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('com.coreplantform.daemonproceed.controller.grpc.ConfigManagerService', rpc_method_handlers)
...
class ConfigManagerService(object):
    ...
    @staticmethod
    def CancelAddListenerOnGlobalConfig(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/com.coreplantform.daemonproceed.controller.grpc.ConfigManagerService/CancelAddListenerOnGlobalConfig',
            ConfigManager__pb2.CancelAddListenerOnGlobalConfigRequest.SerializeToString,
            ConfigManager__pb2.CancelAddListenerOnGlobalConfigResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
